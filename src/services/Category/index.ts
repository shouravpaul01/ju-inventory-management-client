...
export const createCategoryReq = async (payload: FieldValues) => {
    try {
      const res = await axiosInstance.post("/categories/create-category", payload);
      return res.data;
    } catch (error: any) {
  ...
  export const getSingleCategotyReq = async (
    ...
    try {
      const res = await axiosInstance.get(`/categories/single-category/${categoryId}`);
      return res.data;
    } catch (error: any) {
      return error?.response?.data;
    }
  };
  export const updateCategoryReq = async (categoryId:string,payload: FieldValues) => {
    try {
  ...
  export const updateCategoryActiveStatus = async (categoryId: string,isActive:boolean) => {
    try {
      const res = await axiosInstance.patch(
